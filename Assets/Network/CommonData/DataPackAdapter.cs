...
namespace Network.CommonData
{
    ...
    /// 数据适配器
    /// </summary>
    public static class DataPackAdapter
    {
        /// <summary>
        /// 解包
        /// </summary>
        ...
        /// 封包
        /// </summary>
        public static byte[] Pack(this byte[] bytes, ActionTypeEnum packetType)
        {
        ...
        {
            byte[] packetTypeBytes = BitConverter.GetBytes((int)dataPackage.PacketType);
