...
namespace Network.NetClient
{
    ...
    public class SessionClient
    {
        ...
        /// 请求处理
        /// </summary>
        private CActionHandler actionHandler;
        ...
        public CActionHandler Action { get { return actionHandler; } }
        ...
        public void InitializeAction()
        {
            if (actionHandler == null)
            {
                ...
                actionHandler = obj.AddComponent<CActionHandler>();
        ...
        /// 发送指定类型处理消息
        /// </summary>
        public void SendAction(int actionType, CActionParameter parameter)
        {
